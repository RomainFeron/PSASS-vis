#' @title Circos FST window track
#'
#' @description Draws a track on a circos plot for FST window data. This function is intended for use in the \code{\link{draw_circos_plot}} function.
#'
